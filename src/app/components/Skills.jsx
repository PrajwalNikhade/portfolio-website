...
const Skills = () => {
  ...
  return (
    <div className="py-10 bg-[#F9FAFF]">
      <motion.h2 className="text-3xl font-bold text-center mb-8 underline decoration-[#FDC435] " initial={{x:-100,opacity:0}} transition={{duration:0.5}} whileInView={{ opacity: 1 ,x:0}}>Skills</motion.h2>
